...
def Fil_Analisys(afilterFontes, aRobos, dfFontes):
    ...
    with open(cName_Total_Results, "w") as reference:           # Drop to csv w/ context manager
...
packages = ['pandas', 'openpyxl', 'linecache', 'tabulate', 'time', 'tqdm']
...
# Open a file
#path = 'E:\\ZZ_GitHub\\Data-Analysis-and-Machine-Learning-Projects\\Exercises\\Coverage_Totvs\\'
#path = 'E:\\ZZ_GitHub\\Data-Analysis-and-Machine-Learning-Projects\\Exercises\\SPED_Contribuicoes\\Dados\\'
path = '.\\'
